...
/*
    ...
    public double getIPIDValue(){
        return SmartDashboard.getNumber("i", i);
    }

    public double getDPIDValue(){
        return SmartDashboard.getNumber("d", d);
    }

    public double getFPIDValue(){
        return SmartDashboard.getNumber("f", f);
    }
}