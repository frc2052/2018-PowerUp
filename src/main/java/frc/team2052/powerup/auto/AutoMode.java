...
public abstract class AutoMode extends AutoModeBase {
    ...
    protected List<Action> leftSwitch(){
        List<Action> actions = Arrays.asList(
                ...
                new PickupAction(PickupAction.PickupStateEnum.TIMEDOUTTAKE, 1)//pushes cube out
                );
        return actions;
    }
    ...
    protected List<Action> anotherCubeLeftSwitch(){
        List<Action> actions = Arrays.asList(
                ...
                new PickupAction(PickupAction.PickupStateEnum.INTAKE),
                ...
                new ParallelAction(Arrays.asList(
                        ...
                        new ElevatorAction(Elevator.ElevatorPresetEnum.SWITCH))),
                new PickupAction(PickupAction.PickupStateEnum.OUTTAKE)//pushes cube out
        );
        return actions;
    }
    ...
    protected List<Action> anotherCubeRightSwitch(){
        List<Action> actions = Arrays.asList(
                ...
                new ParallelAction(Arrays.asList(
                        ...
                        new ElevatorAction(Elevator.ElevatorPresetEnum.SWITCH))),
                new PickupAction(PickupAction.PickupStateEnum.OUTTAKE)
        );
        return actions;
    }
    ...
    protected List<Action> anotherCubeRightToScale(){
        List<Action> actions = Arrays.asList(
                ...
                new PickupAction(PickupAction.PickupStateEnum.TIMEDINTAKE, 1)
        );
        return actions;
    }
