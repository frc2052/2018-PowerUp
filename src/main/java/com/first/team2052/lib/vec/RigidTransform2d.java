package com.first.team2052.lib.vec;

import com.first.team2052.lib.interpolables.Interpolable;
 ...
 * Inspired by Sophus
 *
 * @see <a href="https://github.com/strasdat/Sophus/tree/master/sophus">Sophus
 *      github</a>
 */
...
public class RigidTransform2d implements Interpolable<RigidTransform2d> {
     ...
     *
     * @param delta
     *            the velocity to watch
     * @return the resultant rigidTransform
     * @see <a href=
     *      "https://github.com/strasdat/Sophus/blob/master/sophus/se2.hpp">Sophus
     *      se2</a>
     */
